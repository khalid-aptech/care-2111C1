                ...
                <div class="row g-4">
                    <div class="col-sm-6 col-xl-6">
                        <div class="bg-secondary rounded d-flex align-items-center  p-4">
                            ...
                            <div class="ms-5">
                            <h1  style="font-size: 50px ; margin-left:40px ">DOCTOR</h1>
                                <br>
                                <h1 style="color:red; font-size:80px ; text-align:center">21</h1>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-6">
                    ...
                    <div class="col-sm-6 col-xl-6">
                        <div class="bg-secondary text-center rounded p-3">
                            ...
                            <i class="fa fa-chart-line fa-5x text-primary"></i>
                                <h1  style="font-size: 40px ; margin-left:60px">DOCTOR</h1>
                                <br>
                                <h1 style="color:red; font-size:80px">21</h1>
                    ...
                    <div class="col-sm-6 col-xl-6">
                        <div class="bg-secondary text-center rounded p-3">
                            ...
                            <i class="fa fa-chart-area fa-5x text-primary"></i>
                                <h1  style="font-size: 40px ; margin-left:50px">APPOINTMENTS</h1>
                                <br>
                                <h1 style="color:red; font-size:80px">21</h1>
